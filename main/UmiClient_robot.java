...
// UmiClient_robotクラス
// UmiClient_robotプログラムの中心となるクラスです
public class UmiClient_robot implements Runnable {
	...
	void repaint(){
		...
		try {
			...
			while (!".".equals(line)){
				...
				// 船を表示します
				g.fillOval(a - 10, 256 - b - 10, 20, 20);
//				// 得点を船の右下に表示します
//				g.drawString(st.nextToken(),a+10,256-b+10) ;
				// 名前を船の右上に表示します
				g.drawString(obj_name,a+10,256-b-10) ;
